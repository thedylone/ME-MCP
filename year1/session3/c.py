...
from year1.session3.b import Task as TaskB
...
class Task(TaskBase):
    ...
    def task1(self) -> dict[str, str] | dict[str, int]:
        ...
        with open("year1/session3/CID.txt", "r", encoding="utf-8") as file:
    ...
    def task2(self) -> dict[str, int | list[int]]:
        ...
        with open("year1/session3/Best.txt", "w", encoding="utf-8") as file:
