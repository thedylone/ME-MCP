...
class Task(TaskBase):
    ...
    def task1(self) -> None:
        ...
        with (
            open("session8/CIDs.txt", "r", encoding="utf-8") as cids_file,
            open("session8/Names.txt", "r", encoding="utf-8") as names_file,
            open("session8/Marks.txt", "r", encoding="utf-8") as marks_file,
        ):
